...
const RefLinkItems: Array<LinkItemProps> = [
  {
    name: 'Namada.me',
    icon: FiLink,
    route: 'https://namada.thoalt.com/',
    isBlank: true,
  },
  {
    name: 'Github',
    icon: FiGithub,
    route: 'https://github.com/thoalt300995/namada-explorer.git',
    isBlank: true,
  },
  {
    name: 'Report Issues',
    icon: FiAlertCircle,
    route: 'https://github.com/thoalt300995/namada-explorer/issues',
    isBlank: true,
  },
]
